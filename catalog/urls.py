...
urlpatterns = [
	...
	path('products/<color_slug>/', color_view, name='color_detail'),
	...
	path('order/', order_create_view, name='create_order'),
        path('error/404/', get_404, name='404'),
    ...
    path('idata/', id_data, name='id_data'),
	...
	path('filter/<category>/', category_in_products,name="category_in_products"),
	path('page/<link>/', banner,  name="banner"),
